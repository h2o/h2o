...
EOT
?>
<h4 id="listen-mptcp">Listening on an Multipath TCP socket</h4>
<p>
If the <code>type</code> attribute is set to <code>mptcp</code>, h2o will listen on an Multipath TCP socket, instead of a TCP one.
