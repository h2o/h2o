...
MIMEMAP("dll", "application/vnd.microsoft.portable-executable")
...
MIMEMAP("exe", "application/vnd.microsoft.portable-executable")
...
MIMEMAP("mjs", "text/javascript")
MIMEMAP("mml", "application/mathml+xml")
...
MIMEMAP("udeb", "application/vnd.debian.binary-package")
MIMEMAP("usdz", "model/vnd.pixar.usd")
